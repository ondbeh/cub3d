...
static void prepare_step_and_sidestep(t_cub3d *cub3d, t_vector2D ray_dir, t_position *step, t_vector2D *side_dist, t_vector2D delta_dist)
{
    t_position curr_pos;
...
static void calculate_distance(t_cub3d *cub3d, t_direction_hit *hit, t_vector2D ray_dir)
{
    t_position curr_pos;
    t_position step;
